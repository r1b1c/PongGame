...
public class GamePanel extends JPanel implements Runnable{
	...
	static final int GAME_HEIGHT = (int) (GAME_WIDTH * (0.5555)); //URADNO RAZMERJE PING PONG MIZE (5/9, ampak imamo int in zato 0.5555
	...
	GamePanel(){
		...
		gameThread = new Thread(this);//this -> ker implementiramo Runnable
		gameThread.start();
	}
